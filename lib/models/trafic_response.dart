...
//
//     final trafictResponse = trafictResponseFromMap(jsonString);

import 'dart:convert';

class TraficResponse {
    ...
    factory TraficResponse.fromJson(String str) => TraficResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory TraficResponse.fromMap(Map<String, dynamic> json) => TraficResponse(
